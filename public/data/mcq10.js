...
window.MCQ = window.MCQ.concat([
  {
    ...
    "topic": "graph-theory",
    "level": "b",
    "q": "<figure class=\"diagram\"><img src=\"/assets/diagrams/graph.svg\" width=\"333\" height=\"220\" alt=\"Undirected graph on vertices 1 through 6. Edges join 1 to 2 and 5, 2 to 3 and 5, 3 to 4, and 4 to 5 and 6.\" loading=\"lazy\"><figcaption><a href=\"https://commons.wikimedia.org/wiki/File:6n-graf.svg\">AzaToth, based on the graph by Booyabazooka</a>. Public domain.</figcaption></figure><p>How many paths of length exactly 2 lead from vertex 1 to vertex 4? Use ACSL's convention allowing repeated vertices and edges.</p>",
    "choices": [
      "1",
      "2",
      "3",
    ...
    "why": "<p>A two-edge path has one intermediate vertex. The neighbors of 1 are 2 and 5, and the neighbors of 4 are 3, 5, and 6. Only 5 appears in both sets, so the only path is 1 → 5 → 4. This is also the row 1, column 4 entry of the squared adjacency matrix.</p>"
  }
]);

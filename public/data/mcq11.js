...
window.MCQ = window.MCQ.concat([
  {
    ...
    "level": "b",
    "q": "<figure class=\"diagram\"><img src=\"/assets/diagrams/half-adder.svg\" width=\"360\" height=\"200\" alt=\"A and B each feed both gates. The upper XOR gate outputs S, and the lower AND gate outputs C.\" loading=\"lazy\"><figcaption><a href=\"https://commons.wikimedia.org/wiki/File:Half_Adder.svg\">Inductiveload, SVG condensed by Aflafla1</a>. Public domain.</figcaption></figure><p>For A = 1 and B = 1, what are the outputs S and C, in that order?</p>",
    "choices": [
      "0 1",
      "1 0",
      "1 1",
    ...
    "why": "<p>The upper gate is XOR, which outputs 0 when both inputs are 1. The lower gate is AND, which outputs 1 for these inputs. Thus S = 0 and C = 1. The two gates share their inputs but have separate outputs.</p>"
  }
]);
...
window.MCQ = window.MCQ.concat([
  {
    ...
    "topic": "digital-electronics",
    "level": "b",
    "q": "<figure class=\"diagram\"><img src=\"/assets/diagrams/half-adder.svg\" width=\"360\" height=\"200\" alt=\"A and B each feed both gates. The upper XOR gate outputs S, and the lower AND gate outputs C.\" loading=\"lazy\"><figcaption><a href=\"https://commons.wikimedia.org/wiki/File:Half_Adder.svg\">Inductiveload, SVG condensed by Aflafla1</a>. Public domain.</figcaption></figure><p>Feed S and C into an additional OR gate. For how many input pairs (A, B) is that final output 1?</p>",
    "choices": [
      "3",
      "1",
      "2",
    ...
    "why": "<p>For 00, both outputs are 0. For 01 and 10, S is 1 and C is 0. For 11, S is 0 and C is 1. Their OR is therefore 1 on three of the four rows. The final output equals A OR B.</p>"
  }
]);

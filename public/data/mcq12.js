...
Getting that order backwards is the single most common source of wrong answers in this category, and
it only ever shows up on SUB and DIV, since ADD and MULT give the same result either way.` },
...
where s[i] is compared against s[N - 1 - i], and dropping that minus 1 is the most common error in the
whole category.` },

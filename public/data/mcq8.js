...
window.MCQ = window.MCQ.concat([
  {
    ...
    "topic": "data-structures",
    "level": "b",
    "q": "<figure class=\"diagram\"><img src=\"/assets/diagrams/binary-search-tree.svg\" width=\"500\" height=\"417\" alt=\"Binary search tree rooted at 8. Its left subtree is rooted at 3 with children 1 and 6. Node 6 has children 4 and 7. The right subtree is rooted at 10, whose right child is 14 with left child 13.\" loading=\"lazy\"><figcaption><a href=\"https://commons.wikimedia.org/wiki/File:Binary_search_tree.svg\">Derrick Coetzee, Booyabazooka, and Inductiveload</a>. Public domain.</figcaption></figure><p>Starting with this tree, insert 5, then delete 3 using ACSL's deletion rule: promote the left subtree and attach the original right subtree at its rightmost node. What is the preorder traversal?</p>",
    "choices": [
      "8 1 6 4 5 7 10 14 13",
      "8 4 1 6 5 7 10 14 13",
      "1 4 5 6 7 8 10 13 14",
      "8 1 4 5 6 7 10 14 13",
      "None of the above"
    ],
    "ans": 0,
    "check": "trav(['+8', '+3', '+10', '+1', '+6', '+14', '+4', '+7', '+13', '+5', '-3'], \"pre\")",
    "why": "<p>5 becomes the right child of 4. Deleting 3 promotes its left child, 1, and attaches the subtree rooted at 6 as the right child of 1. Preorder visits each root before its left and right subtrees, giving 8, 1, 6, 4, 5, 7, 10, 14, 13.</p>"
  }
]);
...
window.MCQ = window.MCQ.concat([
  {
    ...
    "topic": "data-structures",
    "level": "b",
    "q": "<figure class=\"diagram\"><img src=\"/assets/diagrams/binary-search-tree.svg\" width=\"500\" height=\"417\" alt=\"Binary search tree rooted at 8. Its left subtree is rooted at 3 with children 1 and 6. Node 6 has children 4 and 7. The right subtree is rooted at 10, whose right child is 14 with left child 13.\" loading=\"lazy\"><figcaption><a href=\"https://commons.wikimedia.org/wiki/File:Binary_search_tree.svg\">Derrick Coetzee, Booyabazooka, and Inductiveload</a>. Public domain.</figcaption></figure><p>Starting with this tree, delete 8 using ACSL's deletion rule, then insert 9. What is the preorder traversal?</p>",
    "choices": [
      "3 1 6 4 7 10 9 14 13",
      "10 3 1 6 4 7 9 14 13",
      "3 1 6 4 7 9 10 14 13",
      "1 3 4 6 7 9 10 13 14",
      "None of the above"
    ],
    "ans": 0,
    "check": "trav(['+8', '+3', '+10', '+1', '+6', '+14', '+4', '+7', '+13', '-8', '+9'], \"pre\")",
    "why": "<p>ACSL promotes the left subtree, making 3 the root. The old right subtree rooted at 10 attaches to 7, the rightmost node in the promoted subtree. Inserting 9 follows 3, 6, 7, and 10, then becomes the left child of 10. Read the resulting tree in root-left-right order.</p>"
  }
]);
